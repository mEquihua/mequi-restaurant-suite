-- Creates identity tables: staff, roles, role_permissions, staff_roles, terminals, staff_sessions.
-- Deviation: Added 'id' UUID PK to staff_roles and used UNIQUE NULLS NOT DISTINCT because a NULL location_id in a composite primary key is invalid in PostgreSQL.
...
CREATE TRIGGER set_updated_at_staff_roles
...
CREATE TRIGGER set_updated_at_terminals
...
CREATE TRIGGER set_updated_at_staff_sessions
