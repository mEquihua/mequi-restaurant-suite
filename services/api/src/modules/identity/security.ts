...
const OWNER_AND_MANAGER_PERMISSIONS: readonly string[] = [
  ...
  'orders.orders.cancel', 'orders.fulfillment.dispatch', 'orders.fulfillment.deliver', 'orders.orders.cancel_override',
  'orders.fulfillment.dispatch', 'orders.fulfillment.deliver',
